  ...
  return (
    <div className="max-w-3xl mx-auto p-6 leading-relaxed space-y-6">
      ...
      <p>
        ...
        collects, processes, stores, and protects user data while providing our
        mobile application, website, and related services (“Service”). It
      ...
      <p>
        ...
        community communication. We are committed to transparency, security, and
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>Relationship status (Single, In a Relationship, Married)</li>
        <li>Gender (Male, Female, Non-binary, Prefer not to say)</li>
      </ul>
      <p>
        Providing this information is entirely optional and can be edited or
        deleted anytime from your profile. We use it only to improve
        personalization — such as showing relevant events, Dopins, or community
        recommendations — never for advertising, profiling, or selling user
        data.
      </p>
      ...
      <p>
        ...
        experiences in a privacy-respecting way. Optional fields do not affect
        your ability to use Dopin’s core features and may be removed at any
        time.
      </p>
      <p>
        We do not claim ownership of user-submitted Dopins, event information,
        or messages.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>User data: retained as long as your account remains active.</li>
        <li>
          Deleted accounts: identifying information (phone, username, and
          profile) is erased, while anonymized activity data may remain for
          operational safety, fraud detection, and analytics.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>Secure database storage and credential hashing.</li>
        <li>Limited employee access under confidentiality agreements.</li>
        <li>Continuous system monitoring and periodic security audits.</li>
      </ul>
      <p>
        We also maintain incident response procedures in compliance with U.S.
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>Correction or deletion of your personal information.</li>
        <li>Limitation of certain data uses (e.g., location tracking).</li>
      </ul>
      <p>
        Requests are verified and processed through{" "}
        <a
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>
          With trusted service providers for hosting, analytics, or security —
          under contractual confidentiality.
        </li>
        <li>If legally required by authorities.</li>
        <li>To protect user safety or prevent fraud.</li>
        <li>
          During a company restructuring, merger, or acquisition — under this
          same policy.
        </li>
      </ul>
      ...
      <p>
        ...
        Dopins or chats. Dopin cannot control the actions of other users who may
      ...
      <p>
        ...
        will notify users through the app or website.
      </p>
      <p>
        Continued use of Dopin after updates means you accept the revised Data
        Policy.
      </p>
